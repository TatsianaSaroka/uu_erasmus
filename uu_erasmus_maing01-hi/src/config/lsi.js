const Lsi = {
  appName: {
    cs: "Aplikace uuErasmus",
    en: "Application uuErasmus",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuErasmus",
      en: "About application uuErasmus",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuErasmus.",
      en: "You can buy your own uuErasmus.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuErasmus.",
      en: "You don't have rights to initialize this uuErasmus.",
    },
  },

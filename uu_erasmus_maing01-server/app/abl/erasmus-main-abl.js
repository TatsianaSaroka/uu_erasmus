...
const Errors = require("../api/errors/erasmus-main-error.js");
...
const logger = LoggerFactory.get("ErasmusMainAbl");

class ErasmusMainAbl {
  constructor() {
...
module.exports = new ErasmusMainAbl();
